...
for i in range(1,10):
    try: 
        xpath = '//*[@id="app"]/div[2]/div[4]/div[1]/ul/li[' + str(i) + ']/a'
...
name_data = []
link = ''
ask_class_name = simpledialog.askstring('Please Enter Class Name', 'Enter ClassName')
...
for i in range(1, last_page +1):
    ...
    elements = driver.find_element(By.CLASS_NAME, "dofhAs")
    hrefs = elements.find_elements(By.CLASS_NAME, ask_class_name)
    for l in hrefs:
        try:
